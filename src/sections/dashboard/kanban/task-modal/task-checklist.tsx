...
TaskChecklist.propTypes = {
  ...
  onCheckItemAdd: PropTypes.func,
  onCheckItemDelete: PropTypes.func,
  onCheckItemCheck: PropTypes.func,
  onCheckItemUncheck: PropTypes.func,
  onCheckItemRename: PropTypes.func,
